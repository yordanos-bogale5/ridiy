...
mixin _$ProfileState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, code, profileAggregationsState);

  @override
  String toString() {
    return 'ProfileState(code: $code, profileAggregationsState: $profileAggregationsState)';
  }
}
...
class _ProfileState implements ProfileState {
  const _ProfileState(
      {this.code, this.profileAggregationsState = const ApiResponseInitial()});
