        ...
        builder: (context, state) {
          if (!state.isAuthenticated) {
            return Center(
              child: Text(
                "Not logged in",
                style: context.bodyLarge?.copyWith(color: ColorPalette.neutralVariant50),
              ),
            );
          }
          return SafeArea(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(state.profile!.mobileNumberFormatted, style: context.labelLarge),
                          ],
                        ),
                        const Divider(indent: 48, height: 16),
                        Row(
                          children: [
                            ...
                            Text(state.profile!.email ?? "-", style: context.labelLarge),
                          ],
                        ),
                        const Divider(indent: 48, height: 16),
                        Row(
                          children: [
                            ...
                            Text(
                              state.profile!.gender?.toEntity.title(context) ?? context.translate.unknown,
