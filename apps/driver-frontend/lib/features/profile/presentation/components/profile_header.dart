...
class ProfileHeader extends StatelessWidget {
  ...
  final Query$ProfileAggregations$driver aggregationsInfo;
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Center(
            child: ActionButtons(
              totalRides: aggregationsInfo.historyOrdersAggregate.first.count?.id ?? 0,
              totalDistanceTraveled: aggregationsInfo.historyOrdersAggregate.first.sum?.distanceBest?.toInt() ?? 0,
