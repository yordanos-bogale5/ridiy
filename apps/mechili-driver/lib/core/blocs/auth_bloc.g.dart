...
AuthState$Authenticated _$AuthState$AuthenticatedFromJson(
    ...
    AuthState$Authenticated(
      ...
      profile: Fragment$ProfileFull.fromJson(
...
AuthState$Error _$AuthState$ErrorFromJson(Map<String, dynamic> json) =>
    AuthState$Error(
      message: json['message'] as String,
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$AuthState$ErrorToJson(AuthState$Error instance) =>
    <String, dynamic>{
